...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void saveUserInfo() async {
    ...
    try {
      ...
      // create realtime database with users node
      // reference the users node as usersRef
      DatabaseReference usersRef =
          FirebaseDatabase.instance.ref().child('users');

      // save user info in userRef by the user_uid
      usersRef.child(firebaseUser.user!.uid).set(userMap);
